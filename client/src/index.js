...
const steps = [
  ...
  },
  {
    ...
    component: (
      <img
        src="https://stimg.cardekho.com/images/carexteriorimages/630x420/Kia/Seltos/6226/1619864569028/front-left-side-47.jpg?tr=w-456"
        alt="menupic"
  ...
  },
  {
    ...
    options: [
      ...
      {
        value: "Decide which model to buy",
        label: "Decide which model to buy",
        trigger: "22",
      },
  ...
  },
  {
    id: "20",
    message:
      "You will get a call from our team very soon to setup the test drive.",
    trigger: "44",
  },
  {
    id: "44",
  ...
  },
  {
    ...
    component: (
      <ul>
        Here are the pricing details and specs<br></br>
        <b>HTE D(Diesel) (Base Model)</b>
  ...
  },
  {
    ...
    options: [
      {
        value: "HTE G(Petrol) (Base Model)",
        label: "HTE G(Petrol) (Base Model)",
        trigger: "35",
      },
      {
        value: "HTK G(Petrol) Top Selling",
        label: "HTK G(Petrol) Top Selling",
        trigger: "36",
      },
      {
        value: "HTK Plus G(Petrol)",
        label: "HTK Plus G(Petrol)",
        trigger: "37",
      },
      {
        value: "HTK Plus iMT(Petrol)",
        label: "HTK Plus iMT(Petrol)",
        trigger: "38",
      },
      { value: "HTX G(Petrol)", label: "HTX G(Petrol)", trigger: "39" },
      { value: "HTX IVT G(Petrol)", label: "HTX IVT G(Petrol)", trigger: "40" },
      {
        value: "GTX Option(Petrol)",
        label: "GTX Option(Petrol)",
        trigger: "41",
      },
      { value: "GTX Plus(Petrol)", label: "GTX Plus(Petrol)", trigger: "42" },
      {
        value: "GTX Plus DCT(Petrol) (Top Model)",
        label: "GTX Plus DCT(Petrol) (Top Model)",
        trigger: "43",
      },
    ],
  },
  ...
  },
  {
    ...
    options: [
      {
        value: "Check out other Diesel models",
        label: "Check out other Diesel models",
        trigger: "24",
      },
      {
        value: "Check out other Petrol models",
        label: "Check out other Petrol models",
        trigger: "45",
      },
