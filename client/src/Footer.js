  ...
  return (
    <section>
      <footer className="bg-white pt-5 d-block fshadow">
        <div className="container-fluid justify-content-center px-lg-5 ">
          <div className="row list-unstyled px-lg-5">
            ...
            <div className="col-lg-4 col-md-6 col-6 pb-3 pr-4">
              ...
              <input
                type="email"
                className="form-control d-inline position-relative"
                placeholder="Enter Email"
              ></input>

              <div
                className="subscribe btn px-lg-4 px-auto py-2 text-white position-absolute d-inline A"
                onClick={() =>
        ...
        <div className="container-fluid down px-lg-5">
          <br></br>
          <div className="float-lg-left float-sm-left px-lg-5 font-weight-bold d-flex justify-content-center">
